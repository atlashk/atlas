package org.atlas.services.notification.persistence.jpa.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.services.notification.persistence.jpa.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.services.notification.persistence.jpa.repository",

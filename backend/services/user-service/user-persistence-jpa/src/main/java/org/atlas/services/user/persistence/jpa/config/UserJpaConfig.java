package org.atlas.services.user.persistence.jpa.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.services.user.persistence.jpa.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.services.user.persistence.jpa.repository",

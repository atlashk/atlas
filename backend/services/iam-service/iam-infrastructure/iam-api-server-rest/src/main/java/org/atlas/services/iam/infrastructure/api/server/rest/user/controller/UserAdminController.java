package org.atlas.services.iam.infrastructure.api.server.rest.user.controller;
...
import org.atlas.services.iam.infrastructure.api.server.rest.user.mapper.UserAdminMapper;
import org.atlas.services.iam.infrastructure.api.server.rest.user.model.admin.CreateUserRequest;
import org.atlas.services.iam.infrastructure.api.server.rest.user.model.admin.RetrieveUserListRequest;
import org.atlas.services.iam.infrastructure.api.server.rest.user.model.admin.UpdateUserRequest;
import org.atlas.services.iam.infrastructure.api.server.rest.user.model.admin.UserResponse;
...
public class UserAdminController {
  ...
  public ApiResponseWrapper<Long> retrieveUserCount() throws Exception {
    Long responseData = userAdminService.retrieveUserCount();
    return ApiResponseWrapper.success(responseData);
  }

package org.atlas.services.catalog.infrastructure.messaging.kafka.consumer;
...
@Slf4j
public class KafkaStockEventConsumer extends BaseKafkaMessageConsumer {
  ...
  public void consumeStockEvent(ConsumerRecord<String, Object> record, Acknowledgment ack) {

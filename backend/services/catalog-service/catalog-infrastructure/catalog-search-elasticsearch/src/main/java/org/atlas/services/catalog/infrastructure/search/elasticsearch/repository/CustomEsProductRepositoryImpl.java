...
public class CustomEsProductRepositoryImpl implements CustomEsProductRepository {
  ...
  public SearchHits<EsProduct> search(SearchProductCriteria criteria, Pageable pageable) {
    ...
    // Add strong preference for in-stock products (boost their relevance score significantly)
    ...
    // Execute search
    return elasticsearchOperations.search(searchQuery, EsProduct.class);
  }
}

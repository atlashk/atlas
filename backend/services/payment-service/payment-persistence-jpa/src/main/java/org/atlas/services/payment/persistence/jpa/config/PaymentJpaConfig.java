package org.atlas.services.payment.persistence.jpa.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.services.payment.persistence.jpa.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.services.payment.persistence.jpa.repository",

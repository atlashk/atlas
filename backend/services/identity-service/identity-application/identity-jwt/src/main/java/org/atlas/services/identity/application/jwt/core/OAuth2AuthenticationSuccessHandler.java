...
import org.atlas.services.identity.application.jwt.authentication.OAuth2LoginService;
...
public class OAuth2AuthenticationSuccessHandler implements AuthenticationSuccessHandler {
  ...
  public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
    ...
    try {
      LoginOutput loginOutput = oauth2LoginService
          .loginWithFederatedIdentity(provider, providerUserId, email, firstName, lastName);

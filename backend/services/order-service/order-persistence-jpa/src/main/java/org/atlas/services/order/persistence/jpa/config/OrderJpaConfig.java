package org.atlas.services.order.persistence.jpa.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.services.order.persistence.jpa.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.services.order.persistence.jpa.repository",

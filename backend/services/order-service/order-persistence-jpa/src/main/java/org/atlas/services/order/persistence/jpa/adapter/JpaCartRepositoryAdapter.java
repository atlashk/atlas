package org.atlas.services.order.persistence.jpa.adapter;

import java.util.Map;
import java.util.Optional;
import java.util.stream.Collectors;
import lombok.RequiredArgsConstructor;
import org.atlas.services.order.application.port.repository.CartRepository;
import org.atlas.services.order.domain.entity.Cart;
import org.atlas.services.order.domain.entity.CartItem;
import org.atlas.services.order.persistence.jpa.entity.JpaCart;
import org.atlas.services.order.persistence.jpa.entity.JpaCartItem;
import org.atlas.services.order.persistence.jpa.mapper.JpaCartMapper;
import org.atlas.services.order.persistence.jpa.repository.JpaCartRepository;

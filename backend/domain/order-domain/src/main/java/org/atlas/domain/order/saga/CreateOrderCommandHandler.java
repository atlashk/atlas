...
public class CreateOrderCommandHandler {
  ...
  public OrderEntity createOrder(SagaCommandEvent command) {
    final FrontCheckoutInput input = (FrontCheckoutInput) command.getSagaContext().get("input");
    if (input == null) {
  ...
  public void compensateCreateOrder(SagaCommandEvent command) {
    OrderEntity order = (OrderEntity) command.getSagaContext().get("order");
    if (order == null) {

package org.atlas.payment.messaging.rabbitmq.consumer;

import com.rabbitmq.client.Channel;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.atlas.common.framework.json.JsonUtil;
import org.atlas.common.framework.saga.core.command.SagaCommandDispatcher;
...
public class RabbitmqSagaCheckoutCommandConsumer extends BaseRabbitmqMessageConsumer {
  ...
  @RabbitListener(
      queues = "saga.checkout.command.payment",

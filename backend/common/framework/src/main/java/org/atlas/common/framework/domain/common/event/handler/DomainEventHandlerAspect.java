package org.atlas.common.framework.domain.common.event.handler;
...
import org.atlas.common.framework.domain.common.event.handler.interceptor.EventHandlerInterceptor;
...
public class DomainEventHandlerAspect {
  ...
  @Around("@within(org.atlas.common.framework.domain.common.event.handler.DomainEventHandler) && execution(* handle(..))")

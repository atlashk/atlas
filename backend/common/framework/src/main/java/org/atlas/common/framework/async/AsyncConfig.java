package org.atlas.common.framework.async;
...
public class AsyncConfig {
  ...
  @Bean
  public TaskExecutor internalEventConsumerTaskExecutor() {
    ...
    taskExecutor.setThreadNamePrefix("internalEventConsumerTaskExecutor-");

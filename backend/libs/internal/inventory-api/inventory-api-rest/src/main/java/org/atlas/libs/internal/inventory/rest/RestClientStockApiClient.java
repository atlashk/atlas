package org.atlas.libs.internal.inventory.rest;
...
public class RestClientStockApiClient implements UserApiClient {
  ...
  public List<UserOutput> call(RetrieveUserListInput request) {
    String url = String.format("%s/api/stocks/internal/list", baseUrl);

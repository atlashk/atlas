package org.atlas.libs.saga.persistence.jpa.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.libs.saga.persistence.jpa.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.libs.saga.persistence.jpa.repository",

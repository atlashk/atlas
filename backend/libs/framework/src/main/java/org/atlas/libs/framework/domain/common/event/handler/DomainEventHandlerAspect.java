...
import org.atlas.libs.framework.domain.common.event.handler.interceptor.EventHandlerInterceptor;
...
public class DomainEventHandlerAspect {
  ...
  @Around("@within(org.atlas.libs.framework.domain.common.event.handler.DomainEventHandler) && execution(* handle(..))")

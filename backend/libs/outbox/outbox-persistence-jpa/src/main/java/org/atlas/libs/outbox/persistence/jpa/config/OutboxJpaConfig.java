package org.atlas.libs.outbox.persistence.jpa.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.libs.outbox.persistence.jpa.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.libs.outbox.persistence.jpa.repository",

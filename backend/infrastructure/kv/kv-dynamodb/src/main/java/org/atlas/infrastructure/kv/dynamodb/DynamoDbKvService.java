...
@Slf4j
public class DynamoDbKvService implements KvService {
  ...
  @Override
  public void put(String tableName, String key, Object value, Duration expiration) {
    try {
  ...
  @Override
  public boolean putIfAbsent(String tableName, String key, Object value) {
    try {
      Map<String, AttributeValue> item = createItem(key, value, null);
      ...
      log.debug("Item already exists with key: {} in table: {}", key, tableName);
      return false;
    } catch (Exception e) {
  ...
  @Override
  public boolean putIfAbsent(String tableName, String key, Object value, Duration expiration) {
    try {
      long ttl = Instant.now().plus(expiration).getEpochSecond();
      Map<String, AttributeValue> item = createItem(key, value, ttl);
  ...
  @Override
  public Optional<Object> get(String tableName, String key) {
    try {
      ...
      throw new RuntimeException(
          "Failed to get item with key: " + key + " from table: " + tableName, e);
    }
  }
  ...
  public boolean exists(String tableName, String key) {
    try {
      ...
      throw new RuntimeException(
          "Failed to check existence of item with key: " + key + " in table: " + tableName, e);
    }
  }
  ...
  public boolean delete(String tableName, String key) {
    try {
      ...
      log.debug("Item not found for deletion with key: {} in table: {}", key, tableName);
      return false;
    } catch (Exception e) {
      throw new RuntimeException(
          "Failed to delete item with key: " + key + " from table: " + tableName, e);
    }
  }

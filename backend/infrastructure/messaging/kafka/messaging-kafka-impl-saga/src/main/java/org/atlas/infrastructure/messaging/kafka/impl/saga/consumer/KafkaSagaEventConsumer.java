package org.atlas.infrastructure.messaging.kafka.impl.saga.consumer;
...
@Slf4j
public class KafkaSagaEventConsumer extends BaseKafkaMessageConsumer {
  ...
  public void consumeSagaEvent(ConsumerRecord<String, Object> record, Acknowledgment ack) {

package org.atlas.infrastructure.messaging.external.rabbitmq.impl.product;

import com.rabbitmq.client.Channel;
import lombok.extern.slf4j.Slf4j;
import org.atlas.infrastructure.domain.event.handler.DomainEventDispatcher;
import org.atlas.infrastructure.messaging.external.rabbitmq.core.common.RabbitmqConstant;
import org.atlas.infrastructure.messaging.external.rabbitmq.core.consumer.BaseRabbitmqMessageConsumer;
...
public class RabbitmqMessageConsumer extends BaseRabbitmqMessageConsumer {
  ...
  @RabbitListener(
      queues = RabbitmqConstant.QUEUE_PRODUCT_SVC_ORDER_EVENT,

...
@Component
@Slf4j
public class OrderEventConsumer extends KafkaMessageConsumer {

  public OrderEventConsumer(ApplicationContextService applicationContextService) {
    super(applicationContextService);
  }

  @Override
  @KafkaListener(
      topics = KafkaConstant.ORDER_EVENT_TOPIC,

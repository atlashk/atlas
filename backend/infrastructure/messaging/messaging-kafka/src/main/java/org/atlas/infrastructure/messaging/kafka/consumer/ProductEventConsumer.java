...
@Component
@Slf4j
public class ProductEventConsumer extends KafkaMessageConsumer {

  public ProductEventConsumer(ApplicationContextService applicationContextService) {
    super(applicationContextService);
  }

  @Override
  @KafkaListener(
      topics = KafkaConstant.PRODUCT_EVENT_TOPIC,

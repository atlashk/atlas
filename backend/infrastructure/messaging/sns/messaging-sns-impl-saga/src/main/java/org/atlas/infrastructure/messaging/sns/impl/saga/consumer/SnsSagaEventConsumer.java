package org.atlas.infrastructure.messaging.sns.impl.saga.consumer;
...
@Component
@Slf4j
public class SnsSagaEventConsumer extends BaseSnsMessageConsumer implements InitializingBean {

  public SnsSagaEventConsumer(DomainEventDispatcher domainEventDispatcher,
      SnsProps snsProps,
      SqsClient sqsClient) {

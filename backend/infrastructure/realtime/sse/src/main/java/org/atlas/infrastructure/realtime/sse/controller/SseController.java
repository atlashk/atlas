package org.atlas.infrastructure.realtime.sse.controller;
...
public abstract class SseController {
  ...
  /**
   * Checks if this controller can handle the given event type.
   */
  public abstract boolean canHandle(RealtimeEventType eventType);

package org.atlas.infrastructure.persistence.jpa.impl.user.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.infrastructure.persistence.jpa.impl.user.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.infrastructure.persistence.jpa.impl.user.repository",

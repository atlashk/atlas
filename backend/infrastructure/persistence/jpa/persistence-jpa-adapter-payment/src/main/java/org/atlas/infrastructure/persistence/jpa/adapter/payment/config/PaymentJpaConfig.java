package org.atlas.infrastructure.persistence.jpa.adapter.payment.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.infrastructure.persistence.jpa.adapter.payment.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.infrastructure.persistence.jpa.adapter.payment.repository",

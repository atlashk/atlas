package org.atlas.infrastructure.persistence.jpa.impl.order.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.infrastructure.persistence.jpa.impl.order.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.infrastructure.persistence.jpa.impl.order.repository",

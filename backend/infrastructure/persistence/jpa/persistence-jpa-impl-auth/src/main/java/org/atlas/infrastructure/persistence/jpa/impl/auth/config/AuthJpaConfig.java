package org.atlas.infrastructure.persistence.jpa.impl.auth.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.infrastructure.persistence.jpa.impl.auth.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.infrastructure.persistence.jpa.impl.auth.repository",

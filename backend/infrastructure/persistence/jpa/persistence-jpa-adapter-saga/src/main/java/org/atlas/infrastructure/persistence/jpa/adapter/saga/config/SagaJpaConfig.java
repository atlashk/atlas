package org.atlas.infrastructure.persistence.jpa.adapter.saga.config;
 ...
 */
@Configuration
@EntityScan(basePackages = "org.atlas.infrastructure.persistence.jpa.adapter.saga.entity")
@EnableJpaRepositories(
    basePackages = "org.atlas.infrastructure.persistence.jpa.adapter.saga.repository",

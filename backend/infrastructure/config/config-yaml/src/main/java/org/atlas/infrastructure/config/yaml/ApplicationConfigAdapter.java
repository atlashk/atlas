...
public class ApplicationConfigAdapter implements ApplicationConfigPort, InitializingBean {
  ...
  @Override
  public String getConfig(String application, String key, String defaultValue) {
  ...
  private String toKey(String application, String key) {
    return String.format("%s.%s.%s.%s", CONFIG_NODE_PREFIX, activeProfile, application, key);
  }
}

...
# IAM roles for Order Service using comprehensive IAM module
...
resource "aws_ecs_task_definition" "order_service" {
  ...
  cpu                      = var.cpu
  memory                   = var.memory
  execution_role_arn       = module.order_service_iam.ecs_task_execution_role_arn
  task_role_arn            = module.order_service_iam.ecs_task_role_arn

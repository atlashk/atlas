...
export class ApiGatewayService extends Construct {
  ...
  private createECSService(
    ...
    return new ecs.FargateService(this, 'Service', {
      ...
      desiredCount,
      vpcSubnets: {
        subnetType: cdk.aws_ec2.SubnetType.PRIVATE_WITH_EGRESS, // Use private subnets for better security
      },
      securityGroups: [infrastructure.ecsSecurityGroup],
      assignPublicIp: false, // No public IP needed since ALB handles external access

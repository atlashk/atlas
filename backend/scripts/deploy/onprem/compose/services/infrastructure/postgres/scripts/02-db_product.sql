...
INSERT INTO
    product_details (product_id, description)
VALUES
    (
        1,
        'A powerful MacBook with M2 chip and Retina display.'
    ),
    (
        2,
        'Latest Samsung flagship phone with high-end specs.'
    ),
    (
        3,
        'Noise-canceling headphones with amazing sound quality.'
    ),
    (
        4,
        'OLED Smart TV - great for gaming and streaming!'
    ),
    (
        5,
        'High-performance ultrabook with a sleek design.'
    ),
    (
        6,
        'iPad Pro 12.9" - The best tablet for professionals.'
    ),
    (
        7,
        'Premium Android tablet with a powerful chip.'
    ),
    (
        8,
        'Sony''s best Bravia model with Dolby Vision support.'
    ),
    (
        9,
        'NanoCell technology for amazing color accuracy.'
    ),
    ...
    (
        14,
        'UltraGear gaming monitor with 240Hz refresh rate.'
    ),
    (15, 'Corporate laptop optimized for security.'),
    (
        16,
        'Superpower Mac Studio, perfect for professionals.'
    ),
...
-- Alienware m15 → Accessories (Gaming Laptop Add-ons)

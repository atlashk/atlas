...
show_help() {
    ...
    echo "  - Containers: Only those defined in the Atlas compose file"
    ...
    echo ""
    echo "Examples:"
    echo "  $0                      # Clean all Atlas resources"
    echo ""
...
main() {
    ...
    echo "This script will remove ALL Atlas-related Docker resources:"

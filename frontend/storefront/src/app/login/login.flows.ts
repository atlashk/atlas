import type { LoginRequest } from "@/interfaces/authorization.interface";
...
export const resolveProviderLabel = (provider: string | null) => {
...
export const resolveInitialSsoErrorMessage = (args: {

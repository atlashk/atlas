...
export abstract class BaseService {
  ...
  protected async post<T, K = unknown>(endpoint: string, data?: K): Promise<ApiResponse<T>> {
    try {
  ...
  protected async put<T, K = unknown>(endpoint: string, data?: K): Promise<ApiResponse<T>> {
    try {
